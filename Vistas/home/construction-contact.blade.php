...
<body class="pace-on pace-dot">
                ...
                <nav class="collapse navbar-collapse main-navbar logo-navbar navbar-right">
                    <div class="menu-container">
                        <ul class="nav navbar-nav" id="menu-main">
                            ...
                            <li class="menu-item active"> <a href="/construction-contact">Contact us</a> </li>
                        </ul>
                    </div>
                </nav>
            </div>
    ...
    <div id="content" role="main">
        <article>
            <section class="section">
                <div class="background-media" style="background-image: url(assets4/images/construction/img31-notinclude.jpg); background-repeat:no-repeat; background-size:cover; background-attachment:fixed; background-position: 50% 0%;"> </div>
                <div class="background-overlay grid-overlay-0" style="background-color: rgba(0,0,0,0.4);"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="text-center element-top-80 element-bottom-20 text-light os-animation normal regular" data-os-animation="fadeIn" data-os-animation-delay="0s">CONTACT US</h1>
                            <div class="divider-border divider-border-center element-top-20 element-bottom-80 os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.1s">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6 os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.2s">
                                    ...
                                    <div class="wpcf7" dir="ltr" id="wpcf7-f273-p263-o1" lang="en-US">
                                        ...
                                        <form action="contact_mailer.php" class="contact-form">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group form-icon-group"> <i class="fa fa-file-text"></i>
                                                        <input class="form-control" id="subject" name="subject" placeholder="Your subject *" type="text" required=""> </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6 os-animation" data-os-animation="fadeIn" data-os-animation-delay="0.2s">
                                    ...
                                    <div class="google-map" data-os-animation="none" data-os-animation-delay="0s" id="map" style="height:400px"></div>
                                    <div class="divider-wrapper">
                                        <div class="visible-xs element-height-137"></div>
                                        <div class="visible-sm element-height-137"></div>
                                        <div class="visible-md element-height-137"></div>
                                        <div class="visible-lg element-height-137"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="divider-wrapper">
                    ...
                    <div class="row element-top-40 element-bottom-40 footer-columns-4">
                        ...
                        <div class="col-sm-3">
                            <div class="sidebar-widget widget_recent_entries">
                                ...
                                <ul>
                                    <li class="clearfix">
                                        <div class="post-icon">
                                            <a href="corporate-standard-post.html" title="The know how of branding"> <img alt="blog01" class="attachment-thumbnail wp-post-image" height="150" src="assets4/images/corporate/blog011-150x150.jpg" width="150"> </a>
                                ...
                                how of branding</a> <small class="post-date">September 25, 2014</small> </li>
                                    <li class="clearfix">
                                        <div class="post-icon">
                                            <a href="corporate-standard-post.html" title="A corporare design to remember"> <img alt="blog02" class="attachment-thumbnail wp-post-image" height="150" src="assets4/images/corporate/blog02-150x150.jpg" width="150"> </a>
                                ...
                                2014</small> </li>
                                    <li class="clearfix">
                                        <div class="post-icon">
                                            <a href="corporate-standard-post.html" title="The blog fundamentals"> <img alt="blog03" class="attachment-thumbnail wp-post-image" height="150" src="assets4/images/corporate/blog03-150x150.jpg" width="150"> </a>
                        ...
                        <div class="col-sm-3">
                            <div class="sidebar-widget widget_text">
                                ...
                                <div class="textwidget"><img alt="headquarters" src="assets4/images/corporate/headquarters.png"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="assets4/js/contact.min.js"></script>
    <!-- load map js -->
    <script>
        window.map = {
            map_type: 'ROADMAP',
            ...
            center_latlng: '',
            markerURL: 'assets4/images/marker.png',
            auto_center: true,
        };
    </script>
    <script src="assets4/js/map.min.js"></script>
</body>
