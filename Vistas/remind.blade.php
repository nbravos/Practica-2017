...
<html>
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="http://192.241.187.240/pages/favicon.ico" />
    ...
    window.onload = function()
    {
      ...
      if (navigator.appVersion.indexOf("Windows NT 6.2") != -1)
        document.head.innerHTML += '<link rel="stylesheet" type="text/css" href="http://192.241.187.240/pages/css/windows.chrome.fix.css" />'
    }
    </script>
  </head>
